...
BENCHMARK(ARMS_Sign)->RangeMultiplier(2)->Range(50, 500);
BENCHMARK(ARMS_Verify)->RangeMultiplier(2)->Range(50, 500);
BENCHMARK(ARMS_Verify_Slow)->RangeMultiplier(2)->Range(50, 500);
BENCHMARK(ARMS_Combine)->RangeMultiplier(2)->Range(50, 500);
BENCHMARK(ARMS_Combine_Slow)->RangeMultiplier(2)->Range(50, 500);
BENCHMARK(ARMS_VerifyAgg)->RangeMultiplier(2)->Range(50, 500);